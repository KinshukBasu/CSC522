...
TRAINING_DATASET = 'Training_ZScore.csv'
TRAINING_Y = 'TrainY.csv'
TEST_DATASET_DIRECTORY = 'testZscored'	# directory name that contains test datasets
...
dfCOMPARE.to_csv('Compare_LR_Zscored.csv', sep=',')

ERROR = abs(TEST_Y_ALL - TEST_Y_ALL_PREDICTED_BELOW_ZERO_REPLACED_TO_ZERO)
print 'Linear Regression for Z-scored'
